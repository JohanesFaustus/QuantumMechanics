...
\begin{align*}
  \hat{c}_{i} | \cdots n_{i} \cdots \rangle         & = (-1)^{v_i}\sqrt{n_{i}} |  \cdots n_{i} - 1 \cdots \rangle    \\
  \hat{c}^\dagger_{i} | \cdots n_{i} \cdots \rangle & = (-1)^{v_i} \sqrt{ 1 - n_i} |\cdots  n_{i} + 1 \cdots \rangle
\end{align*}
...
\begin{equation*}
  \psi^{\dagger}(\mathbf{r})|0\rangle = |r\rangle\qquad
  \psi(\mathbf{r})|r'\rangle = \delta(\mathbf{r} - \mathbf{r}')|0\rangle
\end{equation*}
