...
\begin{equation*}
  ...
  \psi(\mathbf{r})|r'\rangle = \delta(r - r')|0\rangle
\end{equation*}
...
\subsubsection{Derivation: quantum field operator}
...
\begin{align*}
  \int d^3 r \; \langle 1_\alpha | \mathbf{r} \rangle \psi(r)
...
\begin{equation*}
  ...
  \sum_{k} | k \rangle \langle k | = \mathbf{1} \qquad
...
\end{equation*}
\end{document}
% TODO: derive the diagonal quadratic hamiltonian using bogiubov transformation