...
\subsubsection{Quantum Field Operator}
...
\begin{align*}
  a_{\alpha}           & \rightarrow \psi(\mathbf{r}) = \sum_{\alpha} \langle r | 1 \alpha \rangle a_{\alpha} = \sum_{\alpha} u_{\alpha}(\mathbf{r}) a_{\alpha}                            \\
  a_{\alpha}^{\dagger} & \rightarrow \psi^{\dagger}(\mathbf{r}) = \sum_{\alpha} \langle 1 | r \rangle a_{\alpha}^{\dagger} = \sum_{\alpha} u_{\alpha}^{*}(\mathbf{r}) a_{\alpha}^{\dagger}
\end{align*}
...
\begin{align*}
a_{\alpha} & =  \int d^3 r \, \langle 1_{\alpha} | r \rangle \psi_{\sigma} (\mathbf{r}) = \int d^3 r \, u_{\alpha}^{*} (\mathbf{r}) \psi (\mathbf{r})\\
a_{\alpha}^{\dagger} & =  \int d^3 r \{ r | 1_{\alpha} \rangle \psi^{\dagger} (\mathbf{r}) \} = \int d^3 r \, u_{\alpha} (\mathbf{r}) \psi^{\dagger} (\mathbf{r})
\end{align*}
...
\begin{equation*}
a_\mathbf{k} = \int d^3 r \, e^{-i \mathbf{k} \cdot \mathbf{r}} \psi(\mathbf{r})\quad
a_\mathbf{k}^{\dagger} = \int d^3 r \, e^{i \mathbf{k} \cdot \mathbf{r}} \psi^{\dagger}(\mathbf{r})
\end{equation*}
and its inverse
\begin{equation*}
\psi(\mathbf{r}) = \frac{1}{V} \sum_\mathbf{k} e^{i \mathbf{k} \cdot \mathbf{r}} a_\mathbf{k}\quad
