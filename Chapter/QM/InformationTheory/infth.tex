...
For instance, if $I$ and $J$ are independent, then knowing $I$ does not give any information about $J$ and vice versa, so their mutual information should be zero.
On the other extreme, if $I$ and $J$ are identical, which is a case of “perfect correlation”, then all information conveyed by $I$ is shared with $Y$. 
Or in other words, knowing $X$ determines the value of $Y$ and vice versa. 
