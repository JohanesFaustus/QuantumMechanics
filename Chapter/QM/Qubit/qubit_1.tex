...
\end{align*}
Alternatively, by assuming that $\rho_{11}\geq 0.5$ we can use our previous equation
\begin{align*}
  \mathcal{E}_\text{pop} [\rho]  
& = B \left[ 2\rho_{11}-1+ \sqrt{1-4(1-\rho_{11})\rho_{11}} \right] \\
& = B \left[ 2\rho_{11}-1+ \sqrt{(1 - 2\rho_{11})^2 } \right] \\
& = B \left[ 2\rho_{11}-1+ ( 2\rho_{11} -1 )\right] \\ 
  \mathcal{E}_\text{pop} [\rho]  
...
\begin{equation*}
  \mathcal{E}_\text{pop} \left[ \rho^{(1)}_{C_2} \right]= 2B(2 \sin^2 \frac{\theta }{2 }-1)  
\end{equation*}
and
\begin{equation*}
...
The population ergotropy for both 
\begin{equation*}
  \mathcal{E}_\text{pop} \left[ \rho^{(1)}_{C_3} \right]= 2B(2 \sin^2 \frac{\theta }{2 }-1)  
\end{equation*}
and
\begin{equation*}
