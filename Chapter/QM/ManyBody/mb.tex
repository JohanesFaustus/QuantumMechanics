...
\begin{equation*}
  \psi_{k}(\mathbf{r}) = e^{i \mathbf{k} \cdot \mathbf{r}} u_{k}(\mathbf{r}),
\end{equation*}
...
\begin{align*}
  T_\mathbf{a}\psi(\mathbf{r})
  = \psi_{\mathbf{k}}(\mathbf{r} + \mathbf{a})
  = e^{i \mathbf{k}(\mathbf{r}+\mathbf{a})}u_{\mathbf{k}}(\mathbf{r} + \mathbf{a})
  = e^{i \mathbf{k }\cdot \mathbf{r}} e^{i \mathbf{k }\cdot \mathbf{a}} u_{\mathbf{k}}(\mathbf{r})
  = e ^{i \mathbf{k }\cdot \mathbf{a}}\psi_{\mathbf{k}}(\mathbf{r})
\end{align*}
In other words, a shift by $r$, yields extra phase constant $e^{i \mathbf{k }\cdot \mathbf{a}}$.
It also can be interpreted that the constant is the eigenvalue of translational operator.
\end{document}