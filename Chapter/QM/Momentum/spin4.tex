...
\begin{equation*}
    H \ket{k } =
    \begin{cases}
        -2 \sum_{j=2}^{N}  J_{1j} \ket{\mathbf{j}} +2 \sum_{j=2}^{N} J_{1j} \ket{k}  -2B\ket{k}      & k=1              \\\\
...
\begin{align*}
    H \ket{\mathbf{N}}
     ...
     & =   -2 \sum_{i=1}^{N-1}  J_{iN} \ket{i} - 2\sum_{\substack{i<j                                        \\j < N}} J_{ij} \ket{\mathbf{N}} + \sum_{i<j}  J_{ij} \ket{\mathbf{N}} + B(N-2)\ket{\mathbf{N}} \\
     & =   -2 \sum_{i=1}^{N-1}  J_{iN} \ket{i} -\sum_{\substack{i<j                                          \\j<N}} J_{ij} \ket{\mathbf{N}} + \sum_{i=1}^{N-1} J_{iN} \ket{\mathbf{N}}  + B(N-2)\ket{\mathbf{N}}
\end{align*}
Now set the ground state to zero, that is we define $H \to H -E_0$
\begin{equation*}
    H \ket{\mathbf{N}} =   -2 \sum_{i=1}^{N-1}  J_{iN} \ket{i} +2 \sum_{i=1}^{N-1} J_{iN} \ket{\mathbf{N}}  -2B \ket{\mathbf{N}}
\end{equation*}
...
\begin{align*}
    -2\sum_{i<j}J_{ij}  P_{ij}\ket{k}
     ...
     & =    -2\sum_{k<j}J_{kj}\ket{\mathbf{j}} -2\sum_{i<k}J_{ik}  \ket{i}  -2\sum_{\substack{i<j               \\i,j \neq k}}J_{ij}\ket{k} \\
...
\begin{equation*}
    H \ket{k } =
    \begin{cases}
        -2 \sum_{j=2}^{N}  J_{1j} \ket{\mathbf{j}} - \sum_{j=2}^{N} J_{1j} \ket{k}+3 \sum_{\substack{2\leq i   \\i<j}} J_{ij} \ket{k}  -2B\ket{k} & k=1              \\\\
