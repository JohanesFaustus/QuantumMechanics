...
\begin{equation*}
    \ket{\tilde{m }} = a_m \sum_{j=1} ^{N} \cos \left[ \frac{\pi }{2N }(m-1 ) (2j-1)\right]  \ket{j}
\end{equation*}
...
with 
\begin{equation*}
    g_N = \sum_{m=1 } ^N  a_m^2 e ^{-4it (1 - \cos \pi(m-1) /N )} \cos \left[ \frac{\pi }{2N }(m-1 ) (2r-1) \right] \cos \left[ \frac{\pi }{2N }(m-1 ) (2s-1) \right] 
\end{equation*}
