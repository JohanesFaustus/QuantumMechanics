...
\end{align*}
% \begin{equation*}
%     g_N(t) \approx \frac{2}{(2Jt_c)^{1/3}} \exp\left[ i \left(\frac{\pi N}{2} - 4Jt\right) \right] \operatorname{Ai}\left( -\frac{4J(t - t_c)}{(2Jt_c)^{1/3}} \right)
% \end{equation*}
Substituting this truncated bivariate expansion back into the original integral equation yields:
\begin{equation*}
...
we write 
\begin{equation*}
g_N(t)= 2\left(\frac{2}{N}\right)^{1/3} \exp \left[ i \left( \frac{\pi N}{2} - 4Jt \right) \right] \operatorname{Ai}\left[ 4J(t_c - t) \left( \frac{2 }{N }^{1/3} \right)   \right]    
\end{equation*}
