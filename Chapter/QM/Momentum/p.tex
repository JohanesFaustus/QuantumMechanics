...
The Bloch vector associated with spinor start $\ket{\chi}$ is
\begin{equation*}
...
\begin{equation*}
   [\sigma_z, \sigma_\pm] = \pm 2 \sigma_\pm, \quad [\sigma_+, \sigma_-] = \sigma_z 
\end{equation*}
...
% We have then  
% \begin{equation*}
%     N^{+}_{\frac{1}{2},\frac{1}{2}} = N^{-}_{\frac{1}{2},-\frac{1}{2}} = 0 \quad \text{and} \quad N^{+}_{\frac{1}{2},-\frac{1}{2}} = N^{-}_{\frac{1}{2},\frac{1}{2}} = 1
% \end{equation*}
...
\begin{align*}
    e_x & =  \left( \alpha^* \, \beta^* \right) \begin{bmatrix} 0 & 1 \\ 1 & 0 \end{bmatrix} \begin{bmatrix} \alpha \\ \beta \end{bmatrix} = \alpha^*\beta + \beta^*\alpha = 2\text{Re}(\alpha^*\beta)      \\
    e_y & =  \left( \alpha^* \, \beta^* \right) \begin{bmatrix} 0 & -i \\ i & 0 \end{bmatrix} \begin{bmatrix} \alpha \\ \beta \end{bmatrix} = -i(\alpha^*\beta - \beta^*\alpha) = 2\text{Im}(\alpha^*\beta) \\
    e_z & =  (\alpha^* \beta^*)  \begin{bmatrix} 1 & 0 \\ 0 & -1 \end{bmatrix}  \begin{bmatrix} \alpha \\ \beta \end{bmatrix} = |\alpha|^2 - |\beta|^2
\end{align*}
