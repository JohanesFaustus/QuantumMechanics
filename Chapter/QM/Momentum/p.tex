...
\begin{align*}
[L_i, L_j] &= \epsilon_{ilm} \epsilon_{jnp} [ r_lp_m,r_np_p] \\
&=  \epsilon_{ilm} \epsilon_{jnp}\left(  r_l[p_m, r_n]p_p + r_l r_n[p_m, p_p] + [r_l, r_n] p_m p_p + r_n [r_l, p_p] p_m\right)\\
...
&= i \hbar \left[ \left( r_i p_j -\delta_{ij }r_m p_m\right) -\left( p_i r_j-\delta_{ij }r_l p_p \right)   \right]\\
