...
Any multiplet state has the multiplicity of $2s+1$.
For example, singlet with $s=0$ and $m_s=0$ has one multiplicity and its two particle state can be written as 
\begin{equation*}
    \lvert 0,0\rangle = \frac{1}{\sqrt{2}}\bigl(\lvert\uparrow\downarrow\rangle - \lvert\downarrow\uparrow\rangle\bigr)
\end{equation*}
Another example is triplet with $s=1$ and $m_s=(-1,0,1)$
\begin{equation*}
    \ket{1,m_s} = 
    \begin{cases}
    \lvert 1,-1\rangle = \lvert\downarrow\downarrow\rangle        \\
    \lvert 1,0\rangle = \frac{1}{\sqrt{2}}\bigl(\lvert\uparrow\downarrow\rangle+\lvert\downarrow\uparrow\rangle\bigr)\\
...
\begin{equation*}
    \sigma_ \pm = \frac{1 }{2 }\left( \sigma_1 \pm i\sigma_2 \right)
\end{equation*}
...
\end{equation*}
Instead of considering other case of multiplication, we can cyclically permutate the index and obtain
\begin{equation*}
...
\begin{align*}
    [\sigma_3, \sigma_\pm]
     ...
     & =  \frac{1}{2} \left( 2i\sigma_2 \pm i(-2i\sigma_1) \right) = \frac{1}{2} \left( \pm 2\sigma_1 + 2i\sigma_2 \right) \\
    [\sigma_3, \sigma_\pm]
     & = (\pm \sigma_1 + i \sigma_2) = \pm 2 \sigma_{\pm}
\end{align*}
