...
\begin{equation*}
    ...
    = Js\left[z - \gamma_\mathbf{k} \right] 
    \qquad  \gamma_\mathbf{k} = \sum_{\boldsymbol{\delta}} e^{-i \mathbf{k}\cdot \boldsymbol{\delta}}
\end{equation*}
...
Defining 
\begin{equation*}
    \hbar \omega_{\mathbf{k }} = Js\left[z - \left(\sum_{\boldsymbol{\delta}} e^{-i \mathbf{k}\cdot \boldsymbol{\delta}}\right) \right] 
\end{equation*}
we can also write 
\begin{equation*}
