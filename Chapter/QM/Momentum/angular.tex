...
\begin{align*}
    (231)  =  \mathcal{T}_{13} \mathcal{T}_{12}(123) \qquad
    (312)  =  \mathcal{T}_{12} \mathcal{T}_{13}(123)
\end{align*}
while the odd permutations are
\begin{align*}
    (213)  =  \mathcal{T}_{12}(123) \qquad
    (132)  =  \mathcal{T}_{23}(123) \qquad
...
The simultaneous eigenstates of $\hat{L}^2$ and $\hat{L}_3$
\begin{equation*}
    \hat{L}^2 \ket{l} = l \hbar ^2 (l+1) \ket{l} \qquad
...
since 
\begin{equation*}
    \epsilon_{ijk}\epsilon_{klm} r_l p_l =  
    \epsilon_{ijk}\epsilon_{lmk} r_l p_l =  
    (\delta_{il}\delta_{jm} - \delta_{im}\delta_{lj})    r_l p_l =  
    r_i p_j  -r_jp_i
\end{equation*}
...
\begin{align*}
    ...
    L^2
        & = \hat{L}_3^2 +\hbar  \hat{L}_3 + L^- L^+ =  \hat{L}_3^2 - \hbar \hat{L}_3 + L^+ L^-
\end{align*}
